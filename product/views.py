...
class StandardResultsSetPagination(pagination.PageNumberPagination):
    page_size = 10
    page_size_query_param = 'page_size'  # Permet à l'utilisateur de spécifier la taille de page
...
class ProductPriceViewSet(viewsets.ModelViewSet):
    ...
    http_method_names = ['get', 'post', 'put', 'delete']  # Autorise toutes les actions CRUD
