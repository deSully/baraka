...
SECRET_KEY = "django-insecure-z^ozw%rwp-mgdbt2mp0!)w4wyf_&f-w@4dhusek5h9+-cv-8k*"
...
# URL à utiliser pour servir les fichiers statiques
STATIC_URL = '/static/'

# Dossier où Django collectera tous les fichiers statiques avec collectstatic
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')

# URL publique des fichiers médias (upload utilisateur)
MEDIA_URL = '/media/'
